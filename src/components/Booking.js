...
import './TravelPage.css'; // Import your CSS file for styles
import BookingPage from './BookingPage'; // Assuming BookingPage is in the same directory
...
const TravelPage = () => {
  ...
  return (
    <div className="travel-page-container">
      <h2 className="page-title">Explore Cities in India</h2>
      {selectedCity ? (
